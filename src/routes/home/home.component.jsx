...
const Home = () => {
    const categories = [
        ...
        { id: 6, title: 'shoes', imageUrl: 'https://i.ibb.co/0jqHpnp/sneakers.png',},
        { id: 7, title: 'mens', imageUrl: 'https://i.ibb.co/R70vBrQ/men.png',},
        { id: 8, title: 'womens', imageUrl: 'https://i.ibb.co/GCCdy8t/womens.png',},
      ];
